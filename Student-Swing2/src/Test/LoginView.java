...
public class LoginView extends JFrame {
    ...
    JLabel nameLabel = new JLabel("登录界面",JLabel.CENTER);
    ...
    private void  layoutCenter() {
        ...
        springLayout.putConstraint(SpringLayout.WEST,label,20,SpringLayout.EAST,pwdField);
        springLayout.putConstraint(SpringLayout.SOUTH,label,0,SpringLayout.SOUTH,pwdField);
    }
